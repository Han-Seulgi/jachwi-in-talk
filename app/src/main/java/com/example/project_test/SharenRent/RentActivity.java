...
import com.example.project_test.Writing.RentWritingActivity;
...
public class RentActivity extends AppCompatActivity {
    ...
    private RentRecyclerAdapter adapter2;
    ...
    private String[] term = {"2020-12-14 ~ 2020-12-20", "2020-12-10 ~ 2020-12-19", "2020-12-14 ~ 2020-12-20", "2020-10-04 ~ 2020-10-24", "2020-12-14 ~ 2020-12-20", "2020-12-14 ~ 2020-12-20", "2020-12-14 ~ 2020-12-20", "2020-12-14 ~ 2020-12-20"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        api.getCategory(55).enqueue(new Callback<CategoryData>() {
            @Override
        ...
        adapter2 = new RentRecyclerAdapter();

        data = new ArrayList<>();
        int i = 0;
        while (i < title.length) {
            data.add(new RentListData(img[i], title[i], price[i], term[i]));
            i++;
        }
        ...
        writing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(RentActivity.this, RentWritingActivity.class);
